...
function PrivacyPolicy() {
  return (
    <Layout>
      <div className="container my-8 flex flex-col space-y-4">
        <strong>Privacy Policy</strong>{" "}
        <p>
          Conch AI built the Conch AI app as a Freemium app. This SERVICE is
          provided by Conch AI at no cost and is intended for use as is.
        </p>{" "}
        <p>
        ...
        <p>
          ...
          Terms and Conditions, which are accessible at Conch AI unless
        ...
        <p>
          ...
          not hesitate to contact us at help@getconch.ai.
        </p>{" "}
        <p>
